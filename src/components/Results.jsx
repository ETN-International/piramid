...
import { FileText, ClipboardCheck, GraduationCap, ExternalLink, Globe, Users, Building2, BookOpen } from 'lucide-react';

const Results = () => {
  const results = [
    {
      id: 1,
      title: "P.IR.A.M.iD. Survey Report & Theoretical Model",
      description: "Delivery of a survey to define the realisation of the model. Access the documentation in your preferred language.",
    ...
    {
      id: 2,
      title: "P.IR.A.M.iD. Intercultural Index",
      description: "Development of the Intercultural index (validated test). Measure your intercultural awareness through our platform.",
    ...
    {
      id: 3,
      title: "P.IR.A.M.iD. Course for Students",
      description: "",
      icon: <Users className="w-8 h-8" />,
      type: "link",
      btnText: "Access Course",
      link: "https://www.piramiderasmusplusplatform.com/online-course-for-vet-students"
    },
    {
      id: 4,
      title: "P.IR.A.M.iD. Course for Teachers",
      description: "",
    ...
    {
      id: 5,
      title: "P.IR.A.M.iD. Course for Tutors",
      description: "",
  ...
  return (
    <section id="results" className="section-padding bg-slate-50">
      <div className="container-custom">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-black text-slate-900 mb-6 uppercase tracking-tighter">Project Results</h2>
          <p className="text-xl text-slate-600">
            Explore the tangible outcomes and educational tools developed throughout the PIRAMID project lifespan.
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {results.map((res, index) => (
            ...
            >
              ...
              <h3 className="text-2xl font-black text-slate-900 mb-4 uppercase tracking-tight">{res.title}</h3>
              {res.description && (
                <p className="text-slate-500 mb-10 leading-relaxed font-medium">{res.description}</p>
              )}
              ...
              <div className="mt-auto">
                ...
                {res.type === "link" && (
                  <a 
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className={`inline-flex items-center gap-3 py-4 px-8 bg-eu-blue text-white rounded-2xl font-black uppercase tracking-widest text-xs hover:bg-slate-900 transition-colors shadow-lg shadow-blue-900/20 ${!res.description ? 'mt-4' : ''}`}
                  >
                    {res.btnText}
