  ...
  const packages = [
    {
      ...
      icon: <ClipboardList />,
      title: "Survey & Model",
      desc: "Delivery of a survey to define the realization of the model and theoretical framework.",
      color: "bg-blue-500"
    },
    {
      id: "WP2",
      icon: <BarChart3 />,
      title: "Intercultural Index",
      desc: "Development and validation of a standardized test to measure intercultural competences.",
      color: "bg-piramid-orange"
    },
    {
      id: "WP3",
      icon: <BookOpen />,
      title: "Training Course",
      desc: "Comprehensive modules for students, VET teachers, and host company tutors.",
      color: "bg-eu-blue"
    },
    {
      id: "WP4",
      ...
      desc: "Realization of physical transnational mobilities for students and educators.",
      ...
      <div className="container-custom">
        <div className="flex flex-col lg:flex-row gap-16 items-start">
          <motion.div
            ...
            className="lg:w-1/3"
          >
            <h2 className="text-4xl font-bold mb-6">Work Packages</h2>
            <p className="text-slate-400 text-lg leading-relaxed mb-8">
              The project is structured into four main development phases, ensuring 
              scientific rigor and practical application in real-world tourism settings.
            </p>
            <div className="p-8 bg-white/5 rounded-2xl border border-white/10 backdrop-blur-sm">
              <p className="text-3xl font-bold text-piramid-orange mb-2">4 Phases</p>
              <p className="text-sm text-slate-400 uppercase tracking-widest font-bold">Project Architecture</p>
            </div>
          </motion.div>
