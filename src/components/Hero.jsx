        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-black text-white leading-[1.2] mb-12 tracking-tight">
              {t('hero.titlePart1')} <span className="text-eu-blue italic">{t('hero.titleHighlight')}</span> {t('hero.titlePart2')} <span className="text-piramid-orange uppercase tracking-widest text-3xl md:text-5xl block mt-2">{t('hero.titleEmphasis')}</span>
            </h1>
