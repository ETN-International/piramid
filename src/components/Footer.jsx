          ...
          <div className="col-span-1 lg:col-span-1">
            ...
            <div className="flex space-x-4">
              {[
                ...
                <a key={social.name} href={social.href} target={social.href !== '#' ? '_blank' : undefined} rel={social.href !== '#' ? 'noopener noreferrer' : undefined} className="w-10 h-10 rounded-full bg-white border border-slate-200 flex items-center justify-center text-slate-400 hover:text-eu-blue hover:border-eu-blue hover:shadow-lg transition-all duration-300">
                  {social.icon}
                </a>
              ))}
            </div>
